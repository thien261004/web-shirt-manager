...
<div class="mt-5 col-10 offset-1">
    ...
    <form action="/san_pham_chi_tiet/index?idSanPham=${sanPham.id}" method="GET">
        ...
        <div class="row mt-4">
            <div class="col-6 offset-3 d-flex align-items-center justify-content-center">
                ...
                <a href="/san_pham_chi_tiet/index?idSanPham=${sanPham}" class="btn btn-light mr-2">Làm mới</a>
            </div>
        </div>
    </form>
